                ...
                <div className="container header">
                    ...
                    <ul className="navbar-nav action">
                        <li className="nav-item ml-3">
                            {metamaskConnected ?
                                <button className="btn ml-lg-auto btn-bordered-white"><i className="icon-wallet mr-md-2" />
                                    {accountAddress.substring(0, 6)}...{accountAddress.substring(accountAddress.length - 4)}
                                </button>
                                :
                                <button className="btn ml-lg-auto btn-bordered-white" onClick={connectToMetamask}>
